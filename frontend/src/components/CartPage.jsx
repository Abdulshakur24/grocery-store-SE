...
const CartPage = () => {
  ...
  return (
    <div>
      ...
      <Pageheader
        title="My Cart"
        backgroundImage='https://images.unsplash.com/photo-1542838132-92c53300491e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80'
      />
      <div className='cart'>
